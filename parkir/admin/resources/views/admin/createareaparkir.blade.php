    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Create New Area Parkir</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Create New Area Parkir</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Area Parkir</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kampus_id" name="kampus_id" required>
                                @foreach($kampuses as $kampus)
                                    <option value="{{ $kampus->id }}">{{ $kampus->id }}</option>
                                @endforeach
                            </select>
                        </div>
